...
namespace QDP {
  ...
  {
  public:
    OLatticeJIT( jit_value_t base_, jit_value_t index_) : QDPTypeJIT<T, OLatticeJIT<T> >(base_,index_) {}
  ...
  {
  public:
    OScalarJIT( jit_value_t base_,
		jit_value_t index_) : QDPTypeJIT<T, OScalarJIT<T> >(base_,index_) {}
